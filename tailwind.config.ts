  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'lina-cyan': 'var(--lina-cyan)',
        'lina-dark': 'var(--lina-dark)',
        'lina-medium': 'var(--lina-medium)',
        'lina-light': 'var(--lina-light)',
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
      ...
      backgroundImage: {
        ...
        'text-gradient-teal': 'linear-gradient(to right, #0f766e, #06b6d4)',
      },
    },
  },
