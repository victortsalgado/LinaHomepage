...
export const PageJsr = (): JSX.Element => {
  return (
...
<div className="absolute w-[274px] top-[3346px] left-[300px] [font-family:'Inter',Helvetica] font-bold text-text-color-branco text-base tracking-[0] leading-4 whitespace-nowrap">
...
<div className="absolute w-[1440px] h-[847
px] top-[743px] left-0 bg-[#f8f3f3] rounded-[0px_0px_40px_40px]" />
