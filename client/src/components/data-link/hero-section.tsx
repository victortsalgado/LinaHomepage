              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[600px]">
                ...
                <div className="hidden lg:block relative h-[600px] w-full">
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute top-1/4 left-1/4 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-lg shadow-lg border border-gray-200"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 1.5, duration: 0.5 }}
                    >
                      <span className="text-xs font-medium text-gray-700">Saldos</span>
                    </motion.div>

                    <motion.div
                      className="absolute top-1/3 right-1/4 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-lg shadow-lg border border-gray-200"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 2, duration: 0.5 }}
                    >
                      <span className="text-xs font-medium text-gray-700">Transações</span>
                    </motion.div>

                    <motion.div
                      className="absolute bottom-1/3 left-1/3 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-lg shadow-lg border border-gray-200"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    <motion.div
                      className="absolute bottom-1/4 right-1/3 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-lg shadow-lg border border-gray-200"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 3, duration: 0.5 }}
                    >
                      <span className="text-xs font-medium text-gray-700">Cartões</span>
                    </motion.div>
                  </motion.div>
                </div>
              </div>
