          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
              ...
              >
                ...
                <div className="flex justify-center mb-6 w-full max-w-lg mx-auto mt-[-69px] pt-[103px]">
                  <img 
                    src={linaPay}
                ...
                <div className="text-center px-4 w-full max-w-lg mx-auto mb-[-69px] pb-[103px]">
