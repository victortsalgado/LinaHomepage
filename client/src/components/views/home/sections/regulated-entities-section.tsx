      ...
      <div className="container mx-auto px-6 lg:px-8 max-w-[92rem] relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mt-[-29px] mb-[-29px]">
          ...
          >
            ...
            {/* Description */}
            <div 
              className="text-xl text-gray-700 leading-relaxed space-y-4 mt-8"
          ...
          <div className={`space-y-4 self-start ${contentVisible ? 'scroll-reveal-slide-left' : 'scroll-reveal-hidden'} pl-[58px] pr-[58px] ml-[0px] mr-[0px]`}>
