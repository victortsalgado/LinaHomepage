...
export default function HeroSection() {
  ...
  const StaticContent = () => (
    <div className="h-full flex flex-col justify-center">
      ...
      {/* Title */}
      <h1
        className="mt-8 max-w-4xl mx-auto lg:mx-0 text-balance text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground min-h-[120px] md:min-h-[140px] lg:min-h-[160px] flex items-center"
        ...
        <section>
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div 
                className="grid lg:grid-cols-2 gap-12 items-center min-h-[650px]"
              >
                {/* Left Column - Content */}
                <div className="text-center lg:text-left min-h-[500px] md:min-h-[550px] flex flex-col justify-between">
