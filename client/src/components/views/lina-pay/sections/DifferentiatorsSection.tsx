...
export default function DifferentiatorsSection() {
  ...
  return (
    <section className="relative pt-32 pb-48 md:pt-40 md:pb-64 lg:pt-48 lg:pb-80 overflow-hidden" data-testid="section-differentiators">
      {/* Faixa de fundo diagonal */}
      <div className="absolute inset-0 bg-gradient-to-r from-[var(--lina-dark)] via-[var(--lina-dark)] to-[var(--lina-dark)]" style={{ clipPath: 'polygon(0 0, 100% 0, 100% 85%, 0 100%)' }}></div>
