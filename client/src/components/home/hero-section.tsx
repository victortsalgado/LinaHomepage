...
export default function HeroSection() {
  return (
    <div className="container mx-auto px-8 lg:px-16 pt-[-4px] pb-[-4px] mt-[102px] mb-[102px] pl-[29px] pr-[29px] ml-[99px] mr-[99px]">
      <section
      ...
      >
        <div className="relative z-10 px-12 py-16 lg:py-20 mt-[-114px] mb-[-114px] pl-[47px] pr-[47px] pt-[77px] pb-[77px] ml-[-26px] mr-[-26px]">
              ...
              <div className="relative h-full">
                <div className="relative flex justify-center lg:justify-end h-full items-center ml-[-12px] mr-[-12px]">
                  <img
                    ...
                    className="w-full max-w-xs lg:max-w-sm pl-[50px] pr-[50px] pt-[4px] pb-[4px] mt-[10px] mb-[10px] ml-[9px] mr-[9px]"
